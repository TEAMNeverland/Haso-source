...
async def command(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(".💘اضف البوت اللي مجموعتك", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def m1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("القائمة الرئيسية ⏺", callback_data="command2 " + str(m.from_user.id))],
        [InlineKeyboardButton(".💘اضف البوت اللي مجموعتك", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
...
async def mx1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("القائمة الرئيسية ⏺", callback_data="mxx " + str(m.from_user.id))],
        [InlineKeyboardButton(".💘اضف البوت اللي مجموعتك", url=f"https://t.me/{get_bot_information()[1]}?startgroup=new")],
